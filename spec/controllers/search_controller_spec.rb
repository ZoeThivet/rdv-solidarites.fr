...
RSpec.describe SearchController, type: :controller do
  ...
  let!(:motif) { create(:motif, name: "RSA orientation 1", service: service, bookable_publicly: true, organisation: organisation) }
  let!(:motif2) { create(:motif, name: "RSA orientation 2", service: service, bookable_publicly: true, organisation: organisation) }
